...
function InfoGrid(node){
    ...
    if(node.attributes.nodetype===stackone.constants.DOMAIN){
        url='/node/get_node_info?node_id='+node.attributes.id+'&level='+stackone.constants.DOMAIN;
    }else if(node.attributes.nodetype===stackone.constants.MANAGED_NODE){
        url='/node/get_node_info?node_id='+node.attributes.id+'&level='+stackone.constants.MANAGED_NODE;
    }
