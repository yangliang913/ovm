...
from stackone.core.appliance.ApplianceProxy import ApplianceProxy
from stackone.core.utils.utils import show_url
import pprint
...
# stackone when a particular op is invoked.

from stackone.client.dialogs import ApplianceDetailsDlg
class rPathUI:
    def __init__(self):
