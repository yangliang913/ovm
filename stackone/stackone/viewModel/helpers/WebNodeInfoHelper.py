...
#class WebNodeInfoHelper():
#    def __init__(self):
#        pass
#
#    def get_config_network_info(self, auth, node, op):
#        info_list = NetworkService().get_nw_defns(auth, None, None, node.id, op)
#        return info_list
#
##    def get_config_storage_info(self, auth, node, op):
##        info_list = StorageService().get_server_storage_def_list(auth, node.id, op)
##        return info_list
#    
